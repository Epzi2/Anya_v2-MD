...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Quenn D V2",
    footer: process.env.Footer || "Asᴍᴏᴅᴇᴜs Eᴘᴢɪ",
     ...
     */
    ownername: process.env.Owner_Name || "Asᴍᴏᴅᴇᴜs Eᴘᴢɪ",
     ...
     */
    author: process.env.Author || "Asᴍᴏᴅᴇᴜs Eᴘᴢɪ 💸",
    packname: process.env.PackName || "Queen D V2 pckage",
    socialLink: process.env.Web || "https://github.com/PikaBotz",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/epzi",
